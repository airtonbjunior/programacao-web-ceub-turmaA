let meuArray = ["cachorro", "gato", "coelho", "calopsita", "cobra", "dinossauro", "cavalo", "animal2", "animal3", "animalx", "animaly"];
...
let variavelArray = [5, 4, 8, 0, -7, "abc", 8.3];
...
//console.log(variavelObjeto.endereco.apartamento.aaaa);
